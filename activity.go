...
func (a *Activity) Eval(ctx activity.Context) (done bool, err error) {
	...
	engine := v8.NewIsolate().NewContext()
	val, err := engine.Eval(fmt.Sprintf("parameters = %s; result = {}; %s", string(paramsJSON), a.script), "index.js")
	...
	_ = json.Unmarshal(jsonRaw, &result)
